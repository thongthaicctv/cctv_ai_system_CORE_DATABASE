...
from core.config_manager import find_duplicate_camera_sources, load_config, save_config
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Pro Video AI System  - ATG Solution Version v3.9.3 - visitor: www.annguyen.pro - https://camerathainguyen.com - ĐT: 0208 656 5555 / zalo: 090 414 3113")
        ...
        # ==================================================
        data = load_config()
        self._log_duplicate_camera_sources(data)
        ...
        logo = QLabel("Pro Video AI System  - ATG Solution Version v3.9.3 - visitor: www.annguyen.pro - https://camerathainguyen.com - ĐT: 0208 656 5555 / zalo: 090 414 3113")
    ...
    def _log_duplicate_camera_sources(self, data):
        duplicate_groups = find_duplicate_camera_sources(data)
